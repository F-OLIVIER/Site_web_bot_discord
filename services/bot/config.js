...
export const TODOBotChan = '674275684364845057';
export const TODOBotrappel = '674275684364845057';
export const TODOBotChanOfficier = '715893349931810898';
export const TODOBotReaction = '1111983569900929024';
// Chan et utilisateur à cité dans le message privée
export const TODOchangvg = '674275684364845057';
export const TODOutilisateurofficier = '179655652153491456'; // coincoin
// Utilisateur qui reçois en message privée les sauvegardes automatique de la BDD
export const TODOusermpgetsaveBDD = '179655652153491456'; // coincoin
